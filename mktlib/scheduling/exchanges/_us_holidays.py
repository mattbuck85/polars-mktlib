...
US_RECURRING_HOLIDAYS: list[HolidayRule] = [
    NEW_YEARS_DAY,
    MLK_DAY,
    PRESIDENTS_DAY,
    MEMORIAL_DAY,
...
def us_good_friday_closures(start: date, end: date) -> list[date]:
    """Generate Good Friday closure dates within a range."""
    results: list[date] = []
