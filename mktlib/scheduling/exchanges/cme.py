...
from mktlib.scheduling.rules import AdhocClosure, EarlyClose, day_after, fixed_date_if_weekday
...
EARLY_CLOSES = [
    ...
    EarlyClose("Independence Day", CME_EARLY_CLOSE_TIME, rule=INDEPENDENCE_DAY),
    EarlyClose("Labor Day", CME_EARLY_CLOSE_TIME, rule=LABOR_DAY),
    EarlyClose("Thanksgiving", CME_EARLY_CLOSE_TIME, rule=THANKSGIVING),
    EarlyClose("Black Friday", CME_EARLY_CLOSE_TIME, compute_fn=day_after(THANKSGIVING)),
    EarlyClose("Christmas Eve", CME_EARLY_CLOSE_TIME, compute_fn=fixed_date_if_weekday(12, 24, start_year=1993)),
]
