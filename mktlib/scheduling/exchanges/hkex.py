...
_CHING_MING: dict[int, int] = {
    1990: 5, 1991: 5, 1992: 4, 1993: 5, 1994: 5, 1995: 5, 1996: 4, 1997: 5,
    1998: 5, 1999: 5, 2000: 4, 2001: 5, 2002: 5, 2003: 5, 2004: 4, 2005: 5,
    2006: 5, 2007: 5, 2008: 4, 2009: 4, 2010: 5, 2011: 5, 2012: 4, 2013: 4,
    2014: 5, 2015: 5, 2016: 4, 2017: 4, 2018: 5, 2019: 5, 2020: 4, 2021: 4,
    2022: 5, 2023: 5, 2024: 4, 2025: 4, 2026: 5, 2027: 5, 2028: 4, 2029: 4,
    2030: 5,
}

# Buddha's Birthday (佛誕) — 8th day of 4th lunar month
_BUDDHAS_BIRTHDAY: dict[int, tuple[int, int]] = {
    2007: (5, 24), 2008: (5, 12), 2009: (5, 2), 2010: (5, 21), 2011: (5, 10),
    2012: (4, 28), 2013: (5, 17), 2014: (5, 6), 2015: (5, 25), 2016: (5, 14),
    2017: (5, 3), 2018: (5, 22), 2019: (5, 12), 2020: (4, 30), 2021: (5, 19),
    2022: (5, 8), 2023: (5, 26), 2024: (5, 15), 2025: (5, 5), 2026: (5, 24),
    2027: (5, 13), 2028: (5, 2), 2029: (5, 20), 2030: (5, 9),
}

# Tuen Ng / Dragon Boat Festival (端午) — 5th day of 5th lunar month
_TUEN_NG: dict[int, tuple[int, int]] = {
    2007: (6, 19), 2008: (6, 8), 2009: (5, 28), 2010: (6, 16), 2011: (6, 6),
    2012: (6, 23), 2013: (6, 12), 2014: (6, 2), 2015: (6, 20), 2016: (6, 9),
    2017: (5, 30), 2018: (6, 18), 2019: (6, 7), 2020: (6, 25), 2021: (6, 14),
    2022: (6, 3), 2023: (6, 22), 2024: (6, 10), 2025: (5, 31), 2026: (6, 19),
...
_MID_AUTUMN: dict[int, tuple[int, int]] = {
    2007: (9, 26), 2008: (9, 15), 2009: (10, 3), 2010: (9, 23), 2011: (9, 13),
    2012: (10, 1), 2013: (9, 20), 2014: (9, 9), 2015: (9, 28), 2016: (9, 16),
    2017: (10, 5), 2018: (9, 25), 2019: (9, 14), 2020: (10, 2), 2021: (9, 22),
    2022: (9, 12), 2023: (9, 30), 2024: (9, 18), 2025: (10, 7), 2026: (9, 26),
    2027: (9, 16), 2028: (10, 4), 2029: (9, 23), 2030: (9, 13),
}

# Chung Yeung Festival (重陽) — 9th day of 9th lunar month
_CHUNG_YEUNG: dict[int, tuple[int, int]] = {
    2007: (10, 19), 2008: (10, 7), 2009: (10, 26), 2010: (10, 16), 2011: (10, 5),
    2012: (10, 23), 2013: (10, 13), 2014: (10, 2), 2015: (10, 21), 2016: (10, 9),
    2017: (10, 28), 2018: (10, 17), 2019: (10, 7), 2020: (10, 26), 2021: (10, 14),
    2022: (10, 4), 2023: (10, 23), 2024: (10, 11), 2025: (10, 29), 2026: (10, 18),
...
ADHOC_CLOSURES: list[AdhocClosure] = [
    AdhocClosure(name="Typhoon Bilis & Kaemi 2006-08-06", dates=[date(2008, 8, 6)]),
    ...
    AdhocClosure(name="WWII 70th Anniversary 2015-09-03", dates=[date(2015, 9, 3)]),
    ...
    AdhocClosure(name="Typhoon Kompasu 2021-10-13", dates=[date(2021, 10, 13)]),
