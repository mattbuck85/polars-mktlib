...
class TestOrnsteinUhlenbeck:
    ...
    def test_mean_reversion(self):
        ...
        df = ornstein_uhlenbeck(5000, theta=0.5, mu=100.0, sigma=0.5, x0=200.0, dt=0.1, seed=42)
    ...
    def test_high_theta_faster_reversion(self):
        kwargs = {"n": 500, "mu": 100.0, "sigma": 0.5, "x0": 200.0, "dt": 0.1, "seed": 42}
        ...
        assert abs(fast["value"][100] - 100.0) < abs(slow["value"][100] - 100.0)
